...
PARAM$modelos_rank  <- c( 57, 58, 59, 60, 63, 71, 73, 74, 77, 78 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
