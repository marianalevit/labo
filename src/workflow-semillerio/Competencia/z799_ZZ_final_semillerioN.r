...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990_N"
PARAM$exp_input  <- "HT7510_1"

#Atencion, que cada modelos se procesa con 5 semillas, ajuste a SUS necesidades
PARAM$modelos_rank  <- c( 53, 56, 66, 67, 76 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
